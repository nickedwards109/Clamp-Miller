...
Here is an image of a setup for machining a clamp. In this image, the outer profile of the clamp is being machined, and the slot and height adjustment hole have already been machined. 3 smaller clamps on the right are fixturing the workpiece to the workholding table.
![Use Case](/Use-Case.png)

Here is a preview image of a toolpath generated by Mill-Clamp. The view is from a diagonal perspective to the flat surface of the material stock. Feed motions are represented with white lines.
